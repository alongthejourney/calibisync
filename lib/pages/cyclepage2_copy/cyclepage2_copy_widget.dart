...
import 'cyclepage2_copy_model.dart';
export 'cyclepage2_copy_model.dart';
...
class Cyclepage2CopyWidget extends StatefulWidget {
  const Cyclepage2CopyWidget({super.key});

  static String routeName = 'cyclepage2Copy';
  static String routePath = '/cyclepage2Copy';

  @override
  State<Cyclepage2CopyWidget> createState() => _Cyclepage2CopyWidgetState();
}

class _Cyclepage2CopyWidgetState extends State<Cyclepage2CopyWidget> {
  late Cyclepage2CopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Cyclepage2CopyModel());
                                    ...
                                    children: [
                                      ...
                                      AuthUserStreamWidget(
                                        builder: (context) => StreamBuilder<
                                            List<PeriodLogRecord>>(
                                          stream: queryPeriodLogRecord(
                                            parent: currentUserDocument?.uidd,
                                            queryBuilder: (periodLogRecord) =>
                                                periodLogRecord.where(
                                              'startDate',
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          context.pushNamed(Cyclepage2CopyWidget.routeName);
                        },
                        child: Column(
                          mainAxisSize: MainAxisSize.max,
                          mainAxisAlignment: MainAxisAlignment.center,
