...
import 'cyclepage2_model.dart';
export 'cyclepage2_model.dart';
...
class Cyclepage2Widget extends StatefulWidget {
  const Cyclepage2Widget({super.key});

  static String routeName = 'cyclepage2';
  static String routePath = '/cyclepage2';

  @override
  State<Cyclepage2Widget> createState() => _Cyclepage2WidgetState();
}

class _Cyclepage2WidgetState extends State<Cyclepage2Widget> {
  late Cyclepage2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Cyclepage2Model());
