...
import 'mealtracker2_model.dart';
export 'mealtracker2_model.dart';
...
class Mealtracker2Widget extends StatefulWidget {
  const Mealtracker2Widget({super.key});

  static String routeName = 'mealtracker2';
  static String routePath = '/mealtracker2';

  @override
  State<Mealtracker2Widget> createState() => _Mealtracker2WidgetState();
}

class _Mealtracker2WidgetState extends State<Mealtracker2Widget> {
  late Mealtracker2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Mealtracker2Model());
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              'Click on any macro to see detailed breakdown',
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .labelSmall
                                                  .override(
