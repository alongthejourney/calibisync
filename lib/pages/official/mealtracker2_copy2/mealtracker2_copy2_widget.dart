...
import 'mealtracker2_copy2_model.dart';
export 'mealtracker2_copy2_model.dart';
...
class Mealtracker2Copy2Widget extends StatefulWidget {
  const Mealtracker2Copy2Widget({super.key});

  static String routeName = 'mealtracker2Copy2';
  static String routePath = '/mealtracker2Copy2';

  @override
  State<Mealtracker2Copy2Widget> createState() =>
      _Mealtracker2Copy2WidgetState();
}

class _Mealtracker2Copy2WidgetState extends State<Mealtracker2Copy2Widget> {
  late Mealtracker2Copy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Mealtracker2Copy2Model());
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          context.pushNamed(Mealtracker2Copy2Widget.routeName);
                        },
                        child: Column(
                          mainAxisSize: MainAxisSize.max,
                          mainAxisAlignment: MainAxisAlignment.center,
