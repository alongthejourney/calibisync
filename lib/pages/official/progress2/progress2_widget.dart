...
import 'progress2_model.dart';
export 'progress2_model.dart';
...
class Progress2Widget extends StatefulWidget {
  const Progress2Widget({super.key});

  static String routeName = 'progress2';
  static String routePath = '/progress2';

  @override
  State<Progress2Widget> createState() => _Progress2WidgetState();
}

class _Progress2WidgetState extends State<Progress2Widget> {
  late Progress2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Progress2Model());
