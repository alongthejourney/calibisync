...
import 'personalinfo2_model.dart';
export 'personalinfo2_model.dart';
...
class Personalinfo2Widget extends StatefulWidget {
  const Personalinfo2Widget({super.key});

  static String routeName = 'personalinfo2';
  static String routePath = '/personalinfo2';

  @override
  State<Personalinfo2Widget> createState() => _Personalinfo2WidgetState();
}

class _Personalinfo2WidgetState extends State<Personalinfo2Widget> {
  late Personalinfo2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Personalinfo2Model());
