...
import 'workoutlog2_model.dart';
export 'workoutlog2_model.dart';
...
class Workoutlog2Widget extends StatefulWidget {
  const Workoutlog2Widget({super.key});

  static String routeName = 'workoutlog2';
  static String routePath = '/workoutlog2';

  @override
  State<Workoutlog2Widget> createState() => _Workoutlog2WidgetState();
}

class _Workoutlog2WidgetState extends State<Workoutlog2Widget> {
  late Workoutlog2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Workoutlog2Model());
