...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFA3C4A8);
  late Color secondary = const Color(0xFFF4B6C2);
  late Color tertiary = const Color(0xFF4B3621);
  late Color alternate = const Color(0xFFF7CAC9);
  late Color primaryText = const Color(0xFF4B3621);
  late Color secondaryText = const Color(0xFF6B8F71);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFFCFE2D2);
  late Color accent2 = const Color(0xFFE8A9B8);
  late Color accent3 = const Color(0xFFF7CAC9);
  late Color accent4 = const Color(0xFF6B8F71);
  ...
  late Color customColor1 = const Color(0xFFB6F616);
}
