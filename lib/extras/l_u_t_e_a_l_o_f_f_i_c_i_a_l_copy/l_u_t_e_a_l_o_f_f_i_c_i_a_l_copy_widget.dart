...
import 'l_u_t_e_a_l_o_f_f_i_c_i_a_l_copy_model.dart';
export 'l_u_t_e_a_l_o_f_f_i_c_i_a_l_copy_model.dart';

class LUTEALOFFICIALCopyWidget extends StatefulWidget {
  const LUTEALOFFICIALCopyWidget({super.key});

  static String routeName = 'LUTEALOFFICIALCopy';
  static String routePath = '/lUTEALOFFICIALCopy';

  @override
  State<LUTEALOFFICIALCopyWidget> createState() =>
      _LUTEALOFFICIALCopyWidgetState();
}

class _LUTEALOFFICIALCopyWidgetState extends State<LUTEALOFFICIALCopyWidget> {
  late LUTEALOFFICIALCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LUTEALOFFICIALCopyModel());
