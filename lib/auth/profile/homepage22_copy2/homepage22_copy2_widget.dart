...
import 'homepage22_copy2_model.dart';
export 'homepage22_copy2_model.dart';
...
class Homepage22Copy2Widget extends StatefulWidget {
  const Homepage22Copy2Widget({super.key});

  static String routeName = 'homepage22Copy2';
  static String routePath = '/homepage22Copy2';

  @override
  State<Homepage22Copy2Widget> createState() => _Homepage22Copy2WidgetState();
}

class _Homepage22Copy2WidgetState extends State<Homepage22Copy2Widget>
    with TickerProviderStateMixin {
  late Homepage22Copy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Homepage22Copy2Model());
                  ...
                  child: Row(
                    ...
                    children: [
                      InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          context.pushNamed(Homepage22Copy2Widget.routeName);
                        },
                        child: Column(
                          mainAxisSize: MainAxisSize.max,
