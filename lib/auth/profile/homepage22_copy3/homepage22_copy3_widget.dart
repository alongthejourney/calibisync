...
import 'homepage22_copy3_model.dart';
export 'homepage22_copy3_model.dart';
...
class Homepage22Copy3Widget extends StatefulWidget {
  const Homepage22Copy3Widget({super.key});

  static String routeName = 'homepage22Copy3';
  static String routePath = '/homepage22Copy3';

  @override
  State<Homepage22Copy3Widget> createState() => _Homepage22Copy3WidgetState();
}

class _Homepage22Copy3WidgetState extends State<Homepage22Copy3Widget>
    with TickerProviderStateMixin {
  late Homepage22Copy3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Homepage22Copy3Model());
                                ...
                                children: [
                                  Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        10.0, 10.0, 10.0, 10.0),
                                    child: Text(
                                      'Hey love, your glow starts here. Log your period to \nunlock phase insights, workouts, and more!',
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Row(
                                                      ...
                                                      children: [
                                                        Text(
                                                          'Let\'s get the body moving today!',
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodySmall
                                                              .override(
                                                      ...
                                                      padding:
                                                          const EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  0.0),
                                                      child: Text(
                                                        'It\'s day 14 so its a perfect day to push yourself today! Let\'s log a workout!',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .bodyMedium
                  ...
                  child: Row(
                    ...
                    children: [
                      InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          context.pushNamed(Homepage22Copy3Widget.routeName);
                        },
                        child: Column(
                          mainAxisSize: MainAxisSize.max,
